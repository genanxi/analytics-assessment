...
The project is organized into four primary sections:

### 1. Data Discovery

Review available datasets, understand table relationships, document data lineage, assess data quality, and identify any limitations that may influence the analysis.

### 2. Business Questions

Generate and prioritize business questions based on the available data, domain knowledge, and potential business impact.

### 3. Analytics Framework

Define metrics, analytical datasets, assumptions, and methodologies used to answer the prioritized business questions.

### 4. Findings & Recommendations

Summarize key insights, recommendations, limitations, and potential next steps based on the analysis.

## Supporting Materials

Supporting materials are included throughout the repository:
...
* Visualizations used to communicate findings and support recommendations
* Dashboard concepts designed to operationalize insights and monitor business performance

The level of detail included in each section is intended to provide transparency into both the analytical process and the reasoning behind conclusions and recommendations.
